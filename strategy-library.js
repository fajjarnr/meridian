...
const DEFAULT_STRATEGIES = {
  ...
  single_sided_reseed: {
    ...
    range: { type: "default", bins_below_pct: 100, notes: "All bins below active bin. bins_above=0 (SDK constraint)." },
  ...
  exit_liquidity_spot: {
    ...
    entry: { condition: "SOL-sided only, amount_x=0, bins_above=0 (SDK constraint). Wide bins_below for Bengshark coverage.", single_side: "SOL" },
